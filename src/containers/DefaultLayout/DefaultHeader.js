    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          ...
          minimized={{ src: logoMini, width: 30, height: 30, alt: 'Новое начало' }}
        />
        ...
        <Nav className="ml-auto" navbar>
          ...
          <AppHeaderDropdown direction="down">
            ...
            <DropdownMenu right style={{ right: 'auto' }}>
              ...
              <DropdownItem><i className="fa fa-bell-o" /> Уведомления<Badge color="info">42</Badge></DropdownItem>
              <DropdownItem><i className="fa fa-envelope-o" /> Сообщения<Badge color="success">42</Badge></DropdownItem>
              <DropdownItem><i className="fa fa-tasks" /> Ваши отклики<Badge color="danger">42</Badge></DropdownItem>
              <DropdownItem><i className="fa fa-usd" /> Платежи<Badge color="secondary">42</Badge></DropdownItem>
              <DropdownItem divider />
              <DropdownItem><i className="fa fa-lock" /> Выйти</DropdownItem>
            </DropdownMenu>
          </AppHeaderDropdown>
        </Nav>
